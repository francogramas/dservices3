                ...
                <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                    ...
                    <div class="navi">
                        <ul>
                            ...
                            <li>
                                <a href={{ route('contratistas.index') }}><i class="fas fa-address-card" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Contratistas</span></a>
                            </li>
                            <li>
                                <a href={{ route('servicioscontratistas.index') }}><i class="fa fa-cogs" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Servicios</span></a>
                            </li>
                            <li>
                                <a href={{ route('admusuarios.index') }}><i class="fa fa-users" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Usuarios</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
