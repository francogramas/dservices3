		...
		<div class="row  form-group">
			<div class="col-md-5">						
					<div class="row form-group">
						...
						<div class="col-sm-6">
							<label for="">Nit</label>
							{{ Form::label('codigo',$contratistas->codigo,['id'=>'codigo', 'required','class'=>'form-control']) }}
						</div>
						<div class="col-sm-6">
							<label for="">Razón social</label>
							{{ Form::label('nombre',$contratistas->nombre,['id'=>'nombre', 'required','class'=>'form-control']) }}
						</div>
						<div class="col-sm-6">
							<label for="">Descripción</label>
							{{ Form::label('descripcion',$contratistas->descripcion,['id'=>'descripcion', 'required','class'=>'form-control']) }}
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							...
							{{ Form::label('direccion',$contratistas->direccion,['id'=>'direccion', 'required','class'=>'form-control']) }}
						</div>
						<div class="col-sm-6">
							<label for="">Teléfono</label>
							{{ Form::label('telefono',$contratistas->telefono,['id'=>'telefono', 'required','class'=>'form-control']) }}
						</div>
						<div class="col-sm-6">
						...
						<div class="col-sm-6">
							...
							{{ Form::url('web',$contratistas->web,['id'=>'web', 'required', 'class'=>'form-control']) }}
						</div>
						<div class="col-sm-12">
