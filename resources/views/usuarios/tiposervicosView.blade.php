...
<style type="text/css" scoped="scoped">
    ...
    <div class="row">
        <div class="col-md-12">
            <h2> <span style="color:#ffffff;"><i class="fa fa-map-marker fa-2x"></i>¿Qué tipo de servicios necesitas?</span></h2> 
        </div>
    </div>
        ...
        <div class="row"> 
            @foreach ($tiposervicios as $tiposervicio)
                <div class="col-sm-3 form-group" >
                        <a href={{ route('tiposervicio.show',$sede->id) }} style="width: 100%" class="btn btn-info btn-lg">
