...
<div>
	...
	<input type="hidden" id="servicioscontratistas_id" value=<?php echo e($solicitudes->servicioscontratistas_id); ?>>
</div>
			...
			<div class="modal-body">
				<div class="row form-group">
					<div class="col-sm-12">
						...
						<label id="contratista" class="form-control"><?php echo e($solicitudes->contratista); ?></label>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-12">
						<label for="">Servicio: </label>
						<input id="servicioContratista" type="text" value="<?php echo e($solicitudes->nombre); ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-12">
				...
				<div class="row form-group">
					<div class="col-sm-6">
						...
						<input type="date" id="fecha" class="datepicker" value="<?php echo e($solicitudes->fecha); ?>">
					</div>
					<div class="col-sm-6">
						<label for="">Hora:</label>
						<input type="time" id="hora" value="<?php echo e($solicitudes->hora); ?>">
					</div>
				</div>
				<div class="row form-group">
