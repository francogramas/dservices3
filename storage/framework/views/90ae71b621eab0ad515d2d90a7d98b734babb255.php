		...
		<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<?php echo e(Form::tel('fijo',$user->fijo,['id'=>'fijo','class'=>'form-control wpcf7-form-control wpcf7-text wpcf7-validates-as-required', 'required'])); ?>
			...
			<div class="row">				
				<div class="col-sm-6">
					...
					<?php echo e(Form::text('direccion',$user->direccion,['id'=>'direccion','class'=>'form-control wpcf7-form-control wpcf7-text wpcf7-validates-as-required', 'required'])); ?>
