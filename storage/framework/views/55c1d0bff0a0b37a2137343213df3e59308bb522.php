        ...
        <div class="row"> 
            <?php $__currentLoopData = $tiposervicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiposervicio): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <div class="col-sm-3 form-group" >
                        <a href=<?php echo e(route('servicios.show',$tiposervicio->id)); ?> style="width: 100%" class="btn btn-info btn-lg">
                            <span class="fusion-button-text"><?php echo e($tiposervicio->nombre); ?></span>
                        </a>                                        
                </div>
