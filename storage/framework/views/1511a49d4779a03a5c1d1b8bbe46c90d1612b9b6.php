          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <?php if(Auth::guest()): ?>
                    <li>
                        <a href="<?php echo e(url('/login')); ?>" style="color: #3bafbf;">
                        ...
                        <?php if( Auth::user()->role_id=='1'): ?>
                            <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" style="background-color: transparent;">
                                <li><a href=<?php echo e(route('contratistas.index')); ?>><span class="menu-text menuBarra">Contratistas</span></a></li>                                
                                <li><a href=<?php echo e(url('admin1/admservicioscontratistas')); ?>><span class="menu-text menuBarra">Administrar Servicios contratistas</span></a></li>
                                <li><a href=<?php echo e(route('servicioscontratistas.index')); ?>><span class="menu-text menuBarra">servicioscontratistas</span></a></li>                                
                              </ul>
                            </li>
                            <li class="dropdown" >
                              ...
                              <ul class="dropdown-menu" style="background-color: transparent;">
                                <li><a href=<?php echo e(url('admin1/solicituddetalle')); ?>><span class="menu-text menuBarra">Solicitud Detalle</span></a></li>
                                <li><a href=<?php echo e(route('admsolicitudes.index')); ?>><span class="menu-text menuBarra">Adm. solicitudes</span></a></li>
                                <li><a href=<?php echo e(url('admin1/mostrarsolicitudes')); ?>><span class="menu-text menuBarra">Mostrar solicitudes</span></a></li>

                              </ul>
                            </li>
                            <li><a href=<?php echo e(route('categorias.index')); ?>><span class="menu-text menuBarra">Categorías</span></a></li>
                            <li><a href=<?php echo e(route('sedes.index')); ?>><span class="menu-text menuBarra">Sedes</span></a></li>
                        <?php endif; ?> 
                        <li>
                            <a href="<?php echo e(route('logout')); ?>"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                            <?php echo e(Auth::user()->name); ?> (Salir)
                                        </a>
              ...
              <?php else: ?>
                <?php if( Auth::user()->role_id=='2'): ?>
                  <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href=<?php echo e(url('/')); ?> class="card card--alt-3">
                    ...
                    <li>
                        <a href=<?php echo e(route('membresia.index')); ?> class="card card--alt-1">
                            <i class="card__circle"></i>
                            <span style="color: #ffffff;"><i class="card__icon fa fa-info"></i></span>
                    ...
                    <li>
                        <a href=<?php echo e(url('solicitudestabla')); ?> class="card card--alt-2">
                            <i class="card__circleRed"></i>
                            <span style="color: #a22121;"><i class="card__icon"><?php echo e(dservices\Model\solicitudes::where('users_id',Auth::id())->where('estadosolicitudes_id',6)->count()); ?></i></span>
                            <p><span>Solcitudes</span></p>
                        </a>  
                    </li>
                    <li>
                        <a href=<?php echo e(url('/confirmardatos')); ?> class="card card--alt-4">
                            <i class="card__circle"></i>
                            <span style="color: #ffffff;"><i class="card__icon fa fa-info"></i></span>
